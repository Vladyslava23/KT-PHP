...
<div class="col-md-4 p-3">
  ...
  <div class="row g-0 ">
    <div class="col-md-4">
      <img src="https://i.pinimg.com/736x/b7/21/8a/b7218afa5a91907fbc38ad82c4d08e61.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
 ...
 <div class="card mb-3" style="max-width: 1000px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="https://i.pinimg.com/1200x/f9/63/a2/f963a2736d2f160d9fba39e92a2858dc.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
 ...
 <div class="card mb-3" style="max-width: 1000px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="https://i.pinimg.com/736x/c2/73/c6/c273c6413a0815675aeed1a55be1e485.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
 ...
 <div class="card mb-3" style="max-width: 1000px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="https://i.pinimg.com/1200x/ab/09/ce/ab09ce9031f4ceab171d40181c0b06da.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
 ...
 <div class="card mb-3" style="max-width: 1000px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="https://i.pinimg.com/736x/f2/30/72/f23072d2165dd22644fb29ca2c723dec.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
 ...
 <div class="card mb-3" style="max-width: 1000px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="https://i.pinimg.com/736x/a7/e7/8a/a7e78a9fbbe6bf53a13193598281ae84.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
...
<nav aria-label="...">
  <ul class="pagination">
    <li class="page-item"><a href="tooted.html" class="page-link" aria-current>Previous</a></li>
    <li class="page-item active">
      <a class="page-link" href="tooted.html">1</a></li>
    <li class="page-item"><a class="page-link" href="tooted2.html" aria-current="page">2</a>
    </li>
    <li class="page-item"><a class="page-link" href="tooted2.html">Next</a></li>
  </ul>
</nav>
